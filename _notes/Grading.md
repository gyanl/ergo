...
| 2   | Exercise - Attention Economy             | 10            |
| 3   | Exercise - Ergonomics in the Environment | 10            |
| 4   | Exercise - Laws of UX                    | 10            |
| 5   | Exercise - Types of Errors               | 10            |
| 6   | Final Project                            | 25            |
|     |                                          |               |
...
1. [Exercise - Data Visualisation Tools](https://gyanl.com/dv/exercise-data-visualisation-tools)
2. [Exercise - Data Selfie](https://gyanl.com/dv/exercise-data-selfie)
3. [Exercise - Three Ways of Visualising](https://gyanl.com/dv/exercise-three-ways-of-visualising)
4. [Exercise - Critique and Redesign](https://gyanl.com/dv/exercise-critique-and-redesign)
5. [Exercise - Self Visualising Information](https://gyanl.com/dv/exercise-self-visualising-information)
6. [Exercise - Style a Map](https://gyanl.com/dv/exercise-style-a-map)
7. [Exercise - Dashboard Design](https://gyanl.com/dv/exercise-dashboard-design)
8. [Exercise - Schematic Maps](https://gyanl.com/dv/exercise-schematic-maps)

#### 3. Midsem Project (20%)

The midterm project is a group project (groups up to 3). See [Project - Midsem Project](https://gyanl.com/dv/project-midsem-project).
...
The midterm project is a group project (groups up to 3) due end of April. See [Project - Endsem Project](https://gyanl.com/dv/project-endsem-project).
